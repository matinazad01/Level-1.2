...
public class Jeopardy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		firstButton.setText("");
			...
			askQuestion("What's the square root of 36", "6", 400);
			secondButton.setText("");

		}else if(buttonPressed==thirdButton){
			
			askQuestion("64x=56^3/sqrt(23)", "571.66", 600  );
			thirdButton.setText("");
		}else if(buttonPressed==fourthButton){
			
			askQuestion("What is the quadratic formula?", "x=(-b+or-sqrt(b^2+4ac))/2a)", 800);
			fourthButton.setText("");
		}else if(buttonPressed==fifthButton){
			askQuestion("x^2+6x+9", "3,3", 1000);
			fifthButton.setText("");
			
			
		}else if(buttonPressed==sixthButton){
		askQuestion("6x^2-43x-23", "203.66,-196.5",1200 );
		sixthButton.setText("");
		}
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (question1.equalsIgnoreCase(correctAnswer)) {

			score += prizeMoney;
			updateScore();
			JOptionPane.showMessageDialog(null, "Quick mafs");
